...
export const Testimonials = () => {
  return (
    <section className='grid grid-cols-3   max-w-screen-2xl mx-auto'>
        <div>
            <img src={women1Img} className='h-5/6 w-full object-cover' alt="women-image" />
        </div>
        <div className='flex flex-col gap-4 mt-12'>
            <h2 className='text-6xl text-white text-center font-bold'>WHAT <span className='text-primary text-balance'>OUR</span> CLIENTS SAY?</h2>
            ...
            <article className='flex flex-col mt-7 bg-slate-900 p-8 rounded-3xl m-4'>
                ...
                <div className='flex px-6 items-center pt-4'>
