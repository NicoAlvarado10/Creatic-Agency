...
export const Experience = () => {
  return (
    <section id="pages" className="max-w-7xl mx-auto grid grid-cols-1 max-md:px-4 max-md:gap-4 md:grid-cols-2 items-center justify-center py-40 max-sm:py-16 max-lg:px-4">
        ...
        <div >
            <p className="text-white">Our passion for creativity and innovation drives us to develop unique design solutions that not only impress, but also meet our clients´ strategic objectives. Each project is unique, and we are proud to offer a personalized approach that fits each client´s specific needs.</p>
            <ul className="mt-4">
                <li>
