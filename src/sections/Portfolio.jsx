...
export const Portfolio = () => {
  return (
    <section className=" max-w-screen-2xl mx-auto px-4 py-10 ">
        <h2 className="text-white text-center text-4xl font-bold">ENJOY OUR <span className="text-primary">LATEST</span> <br />PROJECTS</h2>
        <h3 className="font-semibold text-primary text-center mt-6 flex gap-3 justify-center items-center"><span className="border-solid border-white w-20"></span>OUR WORK <span className="border-solid border-white w-20"></span></h3>
         <div className='grid md:grid-cols-3 overflow-hidden  mx-auto justify-center items-center mt-6 gap-10'>
